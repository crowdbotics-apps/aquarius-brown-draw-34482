...
## Project Structure
    ...
    ├── aquarius_brown_draw_34482  # Django project configurations
...
1. Clone this repo and `cd aquarius_brown_draw_34482`
...
2. Clone this repo and `cd aquarius_brown_draw_34482`
